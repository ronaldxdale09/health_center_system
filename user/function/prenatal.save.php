...
$tetanus_1 = isset($_POST['tetanus_1']) ? 1 : 0;
$tetanus_1_date = isset($_POST['tetanus_1_date']) ? $_POST['tetanus_1_date'] : '';

$tetanus_2 = isset($_POST['tetanus_2']) ? 1 : 0;
$tetanus_2_date = isset($_POST['tetanus_2_date']) ? $_POST['tetanus_2_date'] : '';

$tetanus_3 = isset($_POST['tetanus_3']) ? 1 : 0;
$tetanus_3_date = isset($_POST['tetanus_3_date']) ? $_POST['tetanus_3_date'] : '';

$tetanus_4 = isset($_POST['tetanus_4']) ? 1 : 0;
$tetanus_4_date = isset($_POST['tetanus_4_date']) ? $_POST['tetanus_4_date'] : '';

$tetanus_5 = isset($_POST['tetanus_5']) ? 1 : 0;
$tetanus_5_date = isset($_POST['tetanus_5_date']) ? $_POST['tetanus_5_date'] : '';
...
$query = "UPDATE prenatal_record SET patient_id='$patient_id',
    tetanus_1='$tetanus_1', tetanus_1_date='$tetanus_1_date', tetanus_2='$tetanus_2', 
    tetanus_2_date='$tetanus_2_date', tetanus_3='$tetanus_3', tetanus_3_date='$tetanus_3_date', 
    tetanus_4='$tetanus_4', tetanus_4_date='$tetanus_4_date', tetanus_5='$tetanus_5', 
    tetanus_5_date='$tetanus_5_date', blood_pressure='$blood_pressure', weight='$weight', height='$height', 
    ...
    gravida='$gravida', height='$height', smoking='$smoking', alcohol='$alcohol', notes='$notes'
